...
| Field  | Description  | Level  | Type  | Multi Field  | Example  |
|---|---|---|---|---|---|
| <a name="baseline.contact"></a>baseline.contact | Contact responsible for the submission | extended | group |  |  |
| <a name="baseline.revision"></a>baseline.revision | Revision of the baseline control set. | extended | short |  |  |
| <a name="baseline.scope"></a>baseline.scope | Scope of assessment | extended | group |  |  |
| <a name="baseline.hlma"></a>baseline.hlma | Higl Level Maturity Assessment | extended | group |  |  |
| <a name="baseline.tlsa"></a>baseline.tlsa | Technical Level Security Assessment | extended | group |  |  |
...
| Field  | Description  | Level  | Type  | Multi Field  | Example  |
|---|---|---|---|---|---|
| <a name="infosec.unit_code"></a>infosec.unit_code | Information Security Team unit code (based on OAK LDAP unit codes). | extended | keyword |  |  |
| <a name="infosec.log_type"></a>infosec.log_type | Type of log, used so determine index names. | extended | keyword |  |  |
| <a name="infosec.group"></a>infosec.group | Unit or team we receive the logs from, used to determine index names and ACLs. | extended | keyword |  |  |
| <a name="infosec.service"></a>infosec.service | The Information Security Team service (e.g. Baseline Compliance) | extended | keyword |  | `CERT - Computer Security Incident Detection, Response and Prevention` |
...
| Field  | Description  | Level  | Type  | Multi Field  | Example  |
|---|---|---|---|---|---|
| <a name="pras.l1"></a>pras.l1 | PRAS Level 1 - the division. | extended | keyword |  |  |
| <a name="pras.l2"></a>pras.l2 | PRAS Level 2 - the department. | extended | keyword |  |  |
| <a name="pras.l3"></a>pras.l3 | PRAS Level 3 - the sub-department (sometimes use for service). | extended | keyword |  |  |
...
| Field  | Description  | Level  | Type  | Multi Field  | Example  |
|---|---|---|---|---|---|
| <a name="ticket.id"></a>ticket.id | The unique identifier for this ticket | extended | integer |  | `12345` |
| <a name="ticket.subject"></a>ticket.subject | The subject or a short summary for this ticket | extended | text |  | `Huston, we have a problem` |
| <a name="ticket.status"></a>ticket.status | The status of this ticket. It is expected that the set of statuses are a known (short) list. | extended | keyword |  | `resolved` |
| <a name="ticket.priority"></a>ticket.priority | The importance of this ticket as an integer | extended | integer |  | `3` |
| <a name="ticket.queue"></a>ticket.queue | The queue or service of this ticket. It is expected that the queues or services are from a defined list. | extended | keyword |  | `email` |
| <a name="ticket.owner"></a>ticket.owner | The responsible person for this ticket. This should uniquely identify each possible owner, and it is generally expected that this will be a username or email address. | extended | keyword |  | `john.smith@company.example.com` |
| <a name="ticket.requestors"></a>ticket.requestors | The person or person(s) originating or partaking in the request. This is generally expected that this will be a username or email address. | extended | keyword |  | `['john.smith@company.example.com', 'jane.doe@company.example.com']` |
| <a name="ticket.ccs"></a>ticket.ccs | Other people interested in the correspondance that appears on this ticket. This could be an interested party or someone who should be aware of what is going on. It is generally expected that this will be a username or email address. | extended | keyword |  | `['alice@company.example.com', 'bob@company.example.com']` |
| <a name="ticket.adminccs"></a>ticket.adminccs | People other than the owner interested in the full history (including internal comments that happens on this ticket. This could be an an internal party who is not normally interested in other tickets It is generally expected that this will be a username or email address. | extended | keyword |  |  |
| <a name="ticket.created"></a>ticket.created | The date and time the ticket was created. Set by the system automatically. | extended | date |  |  |
| <a name="ticket.starts"></a>ticket.starts | When the ticket should be started. A user set date and time which may have local meaning. | extended | date |  |  |
| <a name="ticket.started"></a>ticket.started | The date and time the ticket was started (i.e. when first taken). Set by the system automatically. | extended | date |  |  |
| <a name="ticket.told"></a>ticket.told | The date and time the ticket was started (i.e. when first taken). Set by the system automatically. | extended | date |  |  |
| <a name="ticket.due"></a>ticket.due | The date and time the ticket should be finished by. This is either user set or determined by the queue default. | extended | date |  |  |
| <a name="ticket.closed"></a>ticket.closed | The date and time the ticket was resolved. Set by the system automatically. | extended | date |  |  |
| <a name="ticket.updated"></a>ticket.updated | The date and time the ticket was last changed in some way (correspondance, comments, status change, etc). Set by the system automatically. | extended | date |  |  |
| <a name="ticket.depends_on"></a>ticket.depends_on | The list of other tickets that this ticket depends on. | extended | long |  |  |
| <a name="ticket.depended_on_by"></a>ticket.depended_on_by | The list of other tickets that this ticket is a dependancy of. | extended | long |  |  |
| <a name="ticket.parents"></a>ticket.parents | The list of other tickets that this ticket is a child of. | extended | long |  |  |
| <a name="ticket.children"></a>ticket.children | The list of other tickets that this ticket is a parent of. | extended | long |  |  |
| <a name="ticket.refers_to"></a>ticket.refers_to | The list of other tickets that this ticket refers to. | extended | long |  |  |
| <a name="ticket.referred_to_by"></a>ticket.referred_to_by | The list of other tickets that refer to this ticket. | extended | long |  |  |
...
| Field  | Description  | Level  | Type  | Multi Field  | Example  |
|---|---|---|---|---|---|
| <a name="veris.incident_confirmation"></a>veris.incident_confirmation | Describes if this item is in fact an incident, and the status of that incident. This is expected to be one of 'Suspected', 'Confirmed', 'False Positive', 'Near miss' or 'Not an incident'. | extended | keyword |  | `Suspected` |
| <a name="veris.threat_actor"></a>veris.threat_actor | Describes the threat actor - the party who is responsible for this incident. This is expected to be at least one of 'External', 'Internal', or 'Partner Organisation'. | extended | keyword |  | `External` |
| <a name="veris.threat_action"></a>veris.threat_action | Describes the threat action - what were the action affecting the asset. This is expected to be at least one of 'Malware', 'Misuse', 'Social', 'Hacking', 'Error', 'Physical', 'Environmental' or 'Unknown'. | extended | keyword |  | `Social` |
| <a name="veris.compromised_assets"></a>veris.compromised_assets | Describes the compromised assets - the things affected by the incident. This is expected to be at least one of 'End-user device', 'People', 'Server', 'Network', 'Media', 'Terminal' or 'Unknown'. | extended | keyword |  | `People` |
| <a name="veris.security_attributes"></a>veris.security_attributes | Describes the security attributes - how the asset was affected. This is expected to be at least one of 'Confidentiality - visiblity', 'Integrity - change or destroy', 'Availability' or 'Other'. | extended | keyword |  | `Integrity - change or destroy` |
| <a name="veris.discovery_method"></a>veris.discovery_method | Describes how the incident was discoverd. This is expected to be at least one of a small number of values taken from <http://veriscommunity.net/enums.html#section-incident_desc>. | extended | keyword |  | `Int - log review` |
...
| Field  | Description  | Level  | Type  | Multi Field  | Example  |
|---|---|---|---|---|---|
| <a name="vulnerability.cves"></a>vulnerability.cves | None | extended | keyword |  |  |
| <a name="vulnerability.cvss"></a>vulnerability.cvss | None | extended | float |  |  |
| <a name="vulnerability.description"></a>vulnerability.description | None | extended | keyword |  |  |
| <a name="vulnerability.test_id"></a>vulnerability.test_id | None | extended | keyword |  |  |
| <a name="vulnerability.test_name"></a>vulnerability.test_name | None | extended | keyword |  |  |
| <a name="vulnerability.test_output"></a>vulnerability.test_output | None | extended | keyword |  |  |
| <a name="vulnerability.severity"></a>vulnerability.severity | None | extended | keyword |  |  |
| <a name="vulnerability.scan_policy"></a>vulnerability.scan_policy | None | extended | keyword |  |  |
| <a name="vulnerability.other_references"></a>vulnerability.other_references | None | extended | keyword |  |  |
| <a name="vulnerability.solution"></a>vulnerability.solution | None | extended | keyword |  |  |
| <a name="vulnerability.affected_software"></a>vulnerability.affected_software | None | extended | keyword |  |  |
| <a name="vulnerability.bids"></a>vulnerability.bids | None | extended | keyword |  |  |
| <a name="vulnerability.certs"></a>vulnerability.certs | None | extended | keyword |  |  |
| <a name="vulnerability.impact"></a>vulnerability.impact | None | extended | keyword |  |  |
| <a name="vulnerability.result_id"></a>vulnerability.result_id | None | extended | keyword |  |  |
| <a name="vulnerability.solution_type"></a>vulnerability.solution_type | None | extended | keyword |  |  |
| <a name="vulnerability.specific_result"></a>vulnerability.specific_result | None | extended | keyword |  |  |
| <a name="vulnerability.task_id"></a>vulnerability.task_id | None | extended | keyword |  |  |
| <a name="vulnerability.task_name"></a>vulnerability.task_name | None | extended | keyword |  |  |
| <a name="vulnerability.detection_method"></a>vulnerability.detection_method | None | extended | keyword |  |  |
| <a name="vulnerability.insight"></a>vulnerability.insight | None | extended | keyword |  |  |
